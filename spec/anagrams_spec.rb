...
describe("String#anagrams") do
  ...
  it('Will compare original string to multiple anagrams and recognize matches') do
    expect('cat'.anagrams('act, tac')).to(eq('act is an anagram of cat.tac is an anagram of cat.'))
  end

  it('Will compare original string to multiple anagrams and recognize non matches') do
    expect('cat'.anagrams('act, butt')).to(eq('act is an anagram of cat.butt is not an anagram of cat.'))
  end
end
